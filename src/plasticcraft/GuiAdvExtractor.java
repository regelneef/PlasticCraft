...
public class GuiAdvExtractor extends GuiContainer {
  private TileEntityAdvExtractor extractorInventory;
	
  public GuiAdvExtractor(InventoryPlayer inventoryplayer, TileEntityAdvExtractor tileentityextract) {
    super(new ContainerAdvExtractor(inventoryplayer, tileentityextract));
    extractorInventory = tileentityextract;
  }

  public void drawGuiContainerForegroundLayer() {
    fontRenderer.drawString("Advanced Extractor", 60, 6, 0x404040);
    fontRenderer.drawString("Inventory", 8, (ySize - 96) + 2, 0x404040);
  }

  protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
    int texture = mc.renderEngine.getTexture(PlasticCraftCore.modDir + "guiAdvExtractor.png");
